...
export default function LoginPage() {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center">
      <div className="mx-[16px] w-[343px] md:mx-0 md:w-full">
        <form action={handleSubmit} className="bg-[#fff]">
          <div className="flex flex-col items-center justify-start gap-[32px]">
            ...
            <div className="flex flex-col items-start justify-start gap-[12px]">
              <section className="group relative h-[60px] w-[343px] shrink-0 text-[14px] md:h-[83px] md:w-[560px] md:text-[18px]">
                <input
                  ...
                  required
                />
                <div className="absolute bottom-[76.6%] left-[3.37%] right-[90.74%] top-0 flex flex-row items-center justify-center bg-[#fff] px-[8px] py-0">
              ...
              <section className="group relative h-[60px] w-[343px] shrink-0 text-[14px] md:h-[83px] md:w-[560px] md:text-[18px]">
                <input
                  ...
                  required
                />
                <div className="absolute bottom-[76.6%] left-[3.19%] right-[79.49%] top-0 flex flex-row items-center justify-center bg-[#fff] px-[8px] py-0">
            ...
            <div className="flex flex-col items-center justify-start gap-[20px]">
              <button
                type="submit"
                className="flex w-[343px] flex-row items-center justify-center rounded-[4px] bg-[#3162fd] px-[143px] py-[20px] md:w-[560px]"
              >
